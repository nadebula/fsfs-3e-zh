...
古代世界没有像版权这样的东西。如果您有一份副本并且想要复制它，无人会告知您您不被允许如此做——除非当地的首领不喜欢书中的内容，此时他可能会因为您复制了这本书而对您进行处罚。但这不是版权，而是与之紧密相关的某种东西，称为审查。而如今版权通常被用于对人们进行审查的企图。
...
为未来的作品延长 20 年的版权期限将会说服人们为创作这些作品付出更多努力，这在理论上是可能想象的，但是这不能说服那些有理性的人们，由于在未来 75 年——如果这篇作品是用于出租的——如果该作品拥有一位个人版权持有人，可能还会更长一些，在此基础上额外增加的 20 年版权期限的存在价值将会大打折扣，小到不能说服任何有理性的人们为此去做一些不同的事情。任何想要宣称事情并非如此的企业应当出示其在未来 75 年中的预期财务状况表，然而它们当然做不到这一点，由于它们当中没有一家会真正看得那么远。
...
最终，索尼想出了一个奸诈的主意。它将一个程序存储在盘片上，于是当您将盘片放入计算机中时，该盘片将会安装该程序。这个程序被设计为像病毒一样取得系统的控制权。它称为 root kit，这意味着其中拥有用于破坏系统安全机制的东西，使得它可以将该软件植入系统深处，并且修改系统中的不同组成部分。
...
请您确保告知人们这种设备意味着什么。它意味着其他读者不再是您的朋友，由于您在他们看来表现得像个傻瓜。一定要先发制人地传播这句话。这款设备是您的敌人，它是任何读者的敌人。那些未能意识到这一点的人们是那些思想短视，未能看穿这一点的人们。我们的任务是帮助他们透过眼前的易用性看穿这款设备的本质。
...
因此，创立这样一种在一定程度上弱化的版权体系是可行并且可接受的，在此体系中，所有商业应用受版权覆盖，所有修改受版权覆盖，但是任何人都拥有对原始副本进行非商业性再分发的自由。

这些自由是我们必须建立起来的针对所有已出版作品的最低限度自由，由于正是对这些自由的否定带来了“消灭分享之战”——它炮制了恶毒的鼓吹的概念：分享就是盗窃，分享就如同成为一名海盗并且攻击船只的行为。这是荒谬的，但是这种由大量金钱支撑的荒谬已经腐化了我们的政府。我们需要终结“消灭分享之战”；我们需要使得分享任何已出版作品的原始版本合法化。

对于这第二大类作品，以上这些就是我们所需要的；我们不必使其成为自由的。因此我认为拥有一种覆盖了商业应用以及任何修改的减弱的版权体系是可以接受的。这可以为作者提供一种收入来源（通常是不充分的），以某种与现有体系或多或少地相同的方式。您必须记住，现有体系除了对于明星大腕以外，通常是完全不充分的。

那么对于艺术娱乐作品又如何呢？在此，我花费了一些时间来决定如何看待修改。

您可以看到，一方面，一幅艺术作品可能具有某种艺术上的完整性，对其进行修改可能会破坏这种完整性。当然，版权并不会必然地阻止作品以这种方式被糟蹋。好莱坞就一直在这样干。另一方面，修改一幅作品也可能成为对艺术的一种贡献。它使得民间处理称为可能，而这可以产出富有美感和意蕴的作品。

即使我们仅仅着眼于著名作家：考虑莎士比亚，他从仅仅过了几十年的作品中借鉴故事情节并且以其他方式呈现，并且创作出了文学史上的巨著。如果今天的版权法在当时也存在，这种创作方式将被禁止，那些剧本也不可能被创作出来。

但是，我最终意识到修改一幅艺术作品可能成为对艺术的贡献，然而这在大多数情况下并非急迫需求。如果您必须等上 10 年以使得版权过期，您是可以等上那么长的时间的。不像今天的版权迫使您等上 75 年或者 95 年。在墨西哥，有时您可能不得不等上将近 200 年，由于墨西哥的版权将会在作者去世的 100 年后过期。这是极其不理智的，但是如我所提议的 10 年作为版权应该持续的时间，人们是可以在有生之年等到的。

因此我提议相同的部分弱化的版权覆盖商业应用和修改，但是每个人都必须拥有对其原始版本进行非商业性再分发的自由。10 年之后，它将进入公有领域，人们可以通过出版他们的修改版本来为艺术作出贡献。

还有一件事情，如果您想要从一系列作品中挑选一些片断并且将其重新编排至某种全新的作品之中，这应当是合法的，由于版权的初衷是促进艺术发展，而非阻碍艺术发展。将版权应用于这种对于作品片断的使用是愚蠢的——它是自相矛盾的。这是一种扭曲，只有当政府被那些现存成功作品的出版商支配的时候才会发生这种事情，并且这已经完全迷失了其初衷。

这就是我所提议的，特别要指出的是，这意味着在互联网上分享副本必须是合法的。分享是美好的。分享构建了社会的契约。反对分享就是反对社会。

因此，每当政府提议新的措施制裁分享作品的人们并且禁止他们分享时，我们必须认识到这是一种罪恶，不仅仅是因为这些被提议的制裁措施无一例外地侵犯了公平的基本理念。但这并非巧合；其原因是，这种提议的目的是罪恶的。分享是美好的，政府应当鼓励分享。

但是不管怎么说，版权确实有其有用的目的。只是版权作为实现该目的的手段现在遇到了问题，由于它不能适应我们所使用的技术。它干涉了读者、听众、观众及其他人的所有基本自由，但是它促进艺术发展的目标仍然是美好的。因此，这种部分弱化的版权体系仍将继续作为版权体系而存在，除此以外，我提议两种其他方式。

其一是（通过）征税——直接将税金分发给作者。这可以是一种特殊税收，可能是对于互联网连接的税收，也可以来自一般性的收入，由于它的总量不会非常大，如果它是通过某种高效的方式分发的。以促进艺术发展为目的对其进行高效分发意味着不是按照作品流行度的线性比例进行分发。它应当基于流行度，由于我们不希望由官僚独断决定哪些作者得到支持而哪些作者将被无视。但是，基于流行度并不意味着按照线性比例。

我所提议的是统计不同艺术家的流行度，您可以通过没有人会被强制参与其中的投票（样本）做到这一点，然后取其立方根。立方根就像这样：它基本意味着（收入）增加值将会逐渐变小。

如果明星大腕 A 的流行度是成功艺术家 B 的 1000 倍，按照这种体系，A 将会得到 10 倍于 B 的收入，而非 1000 倍。

如果按照线性比例，A 将会得到 1000 倍于 B 的收入，这意味着如果我们想让 B 足以维持生计，我们必须使 A 盆满钵满。这是一种对税金的浪费——不应该这样做。

但是如果我们使得收入增量逐渐变小，那么是的，每位明星大腕仍将得到比普通的成功艺术家多得多的收入，但是所有这些明星大腕的收入总和将只占税金（总额）的一小部分。大部分税金将会被用于支持一大批相对成功、相对受欢迎、相对流行的艺术家。因此，这一体系相对于现有的体系将能够更高效地利用这笔税金，。

现有的体系是倒退的。例如对每张唱片，它实际给予明星大腕的钱远远超过其他任何人的。这种花钱的方式非常不合理。其结果是我们以这种方式实际花费的钱要少得多。我希望这足以安慰某些对于税收有着膝跳反应般的敌意的人们——我并不分享税收，由于信任一个福利国家。

我还有一个建议是关于志愿者捐助的。假设每台播放器都有这样一个按钮，您可以通过按下它来向您正在播放的作品或者已经播放的上一部作品的作者发送 1 美元。这笔钱将会被匿名地发送给作者。我相信会有很多人比较经常地按下那个按钮。

例如，我们中的所有人都能够负担得起每天按一次按钮的费用，这不会花费我们那么多钱。这笔钱对于我们是可接受的，我非常确信。当然，也会有贫困的人们不能负担按一下按钮的费用，然而即使他们不去按下按钮也没关系。我们不需要从穷人身上榨取钱财以支持作者。有足够多的经济状况尚可的人们，他们可以很好地完成这件事。我相信您已经注意到，有很多人确实喜爱某种艺术，并且真正乐意支持艺术家。

于是我又有了一个想法。此播放器还可以给您一份证书，表示您曾经支持过某位无名作者，它甚至还可以统计您曾经送出多少次支持，并且给您这样一份证书：“我为这些艺术家付出了这么多。”总之，我们可以通过不同方式鼓励那些想要如此做的人们。

例如，我们可以开展一场友善的公共关系（PR）活动：“您今天向某位艺术家捐助 1 美元了吗？为什么不呢？这只是 1 美元——您将永远不会失去它，您难道不喜爱他们从事的事情吗？请按下按钮！”这将使人们产生好感，他们将会想：“是的，我喜爱我所观看的作品，我将要捐助 1 美元。”

这在一定程度上已经开始产生效果。有一位曾经叫做 Jane Siberry 的加拿大歌手。她将自己的音乐放在自己的网站上，邀请人们下载并且捐助他们所愿意支付的任意金额。她曾经报道收到了平均每份副本多于 1 美元的收入，这是有趣的事情，由于大型唱片公司的收费还不到每份副本 1 美元。通过让人们自行决定是否捐助与捐助多少，她实际上得到了更多——如果按照实际下载了某些东西的访问者来统计，她通过每位访问者得到的甚至更多。但是这可能甚至还没有考虑是否存在这样一种效应，即吸引更多人访问，（从而）增大了这一平均值所对应的总数。

因此，这是可行的，但在当前环境下是一种令人头痛的事。首先您必须拥有一张信用卡，这意味着您不能进行匿名捐助。并且您必须找到去哪里进行支付，而对于小额支付，现有的支付系统并不非常高效，因此艺术家们只是成功了一半。如果我们能够建立一种理想的支付系统，它将能够更好地运作。以上就是我的两条建议。
